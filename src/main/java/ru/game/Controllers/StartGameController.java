...
public class StartGameController extends BaseController
    {
        ...
        @FXML private Image im1;
        @FXML private Image im2;
        @FXML private Image im3;
        ...
        @FXML void initialize(){ start.setVisible(false);}

        @FXML public void start() throws Exception
            {
                if (isNeedInitialize())
                    {
